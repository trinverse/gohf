          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <div className="mt-10 space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-[#1a1a2e]">Email</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-[#1a1a2e]">Phone</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-[#1a1a2e]">Response Time</h3>
              ...
              <div className="mt-10 p-6 rounded-2xl bg-[#f8f9fa] border border-[#e8eaed]">
                <p className="text-sm text-[#5f6368]">
                  <span className="font-medium text-[#1a1a2e]">Note:</span> JNV Alumni Foundation
            ...
            <div className="lg:pl-8">
              <div className="p-8 md:p-10 rounded-3xl bg-white shadow-[0_2px_8px_rgba(0,0,0,0.04)]">
                <h3 className="text-2xl font-semibold text-[#1a1a2e] tracking-tight mb-8">
                  Send a message
                </h3>
                ...
                <form className="space-y-6">
                  ...
                  <div>
                    <label htmlFor="subject" className="block text-sm font-medium text-[#1a1a2e] mb-2">
                      Subject
                    </label>
                    <select
                      id="subject"
